<div class="col-md-12 display-none details{{ $operation->id }}">
    ...
    <div class="col-md-12 mt-3 fs14">
        <div class="row">
            ...
            <div class="col-md-2 mt-4">
                <span class="activeLink">{{ t('exchange_rate') }}</span><br> {{ $operation->to_currency }} = {{ $operation->getExchangeTransaction() ? round($operation->getExchangeTransaction()->exchange_rate, 2) : '-' }}<br><br>
