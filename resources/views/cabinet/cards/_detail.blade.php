<div class="modal fade login-popup rounded-0" id="cardsDetails" tabindex="-1" role="dialog"
        ...
        <div class="modal-content modal-content-centered">
            <div class="modal-header">
                ...
                <div class="w-100 d-flex flex-column justify-center" >
                    ...
                    <h2 style="line-height: inherit" class="wallesterOrderBlocks">{{ t('cards_details') }}</h2>
                        <button id="allDetails" class="btn btn-light ml-1" style="line-height: initial;position: absolute;right: 190px"
                                onclick="copyText(this)">
                            <i class="fa fa-copy" aria-hidden="true"></i>
                        </button>
                    </div>
                    <textarea id="textallDetails" style="position:absolute;left:-10000px;top:-10000px" >{{ $topUpDetailsToCopy }}</textarea>
            ...
            <div class="modal-body">
                ...
                <div class="w-100 d-flex flex-column justify-center">
                    <div class="wallester-top-up-details">
                        ...
                        <button id="recipient" class="btn btn-light ml-1" style="line-height: initial;position: absolute;right: 190px"
                                onclick="copyText(this)">
                            <i class="fa fa-copy" aria-hidden="true"></i>
                        </button>
                    </div>
                    ...
                    <div class="wallester-top-up-details">
                        ...
                        <button id="iban" class="btn btn-light ml-1" style="line-height: initial;position: absolute;right: 190px"
                                onclick="copyText(this)">
                            <i class="fa fa-copy" aria-hidden="true"></i>
                        </button>
                        <input id="textiban"
