                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <h6 id="2fa-confirm-header" class="mb-4">
                                {{ $cUser->two_fa_type == \App\Enums\TwoFAType::EMAIL || $cUser->two_fa_type == \App\Enums\TwoFAType::NONE ? t('ui_2fa_confirm_email_header') : t('ui_2fa_confirm_google_header') }}
                            </h6>
                            <div>
                            ...
                            <div class="form-label-group">
                                <label for="2fa-confirm-code">
                                    {{ $cUser->two_fa_type == \App\Enums\TwoFAType::EMAIL || $cUser->two_fa_type == \App\Enums\TwoFAType::NONE ? t('ui_2fa_confirm_email_label') : t('ui_2fa_confirm_google_label') }}
                                </label>
