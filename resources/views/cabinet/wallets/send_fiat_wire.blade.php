...
@section('title', t('title_withdraw_page'). ' ' . strtoupper($fiatAccount->currency) . ' ' . t('title_wallet_page'))
...
@section('content')
    ...
    <div class="row mb-5">
        <div class="col-md-12">
            <h3 class="mb-3 large-heading-section page-title"> {{ t('title_withdraw_page') . ' ' . strtoupper($fiatAccount->currency) }} Wallet</h3>
            <div class="row">
    ...
    <div class="row">
        <div class="col-md-12">
            <form id="withdraw_wire_form" method="post"
                  action="{{ route('cabinet.fiat.withdraw.wire.operation', $fiatAccount->id) }}">
                @csrf
                ...
                <div class="tab">
                            ...
                            <div class="row mt-5">
                                <ul class="nav nav-cards d-flex w-100 justify-content-center justify-content-sm-start"
                                    ...
                                    <li class="nav-item col-md-4 col-lg-3">
                                        <a href="{{ route('cabinet.fiat.withdraw.wire', $fiatAccount->id) }}"
                    ...
                    <div class="row mt-5">
                        <div class="col-md-3">
                            ...
                            <input class="coin" type="text" hidden value="{{ $fiatAccount->currency }}">
                            ...
                            {{ $availableCurrentAmount . ' ' . $fiatAccount->currency}}
                            </p>

                            <input type="hidden" id="operation_wire_type" value="{{ \App\Enums\OperationType::WITHDRAW_WIRE_FIAT }}"/>
                        </div>
                ...
                <div class="tab">
                    ...
                    <div class="mt-5">
                        ...
                        <input type="hidden" class="currency" name="currency" id="currency" value="{{ $fiatAccount->currency }}"/>
                    </div>
                </div>
                ...
                <div class="tab">
                    ...
                    <div class="row mt-4">
                        ...
                        <input type="hidden" id="bank_currency" name="bank_currency" value="{{ $fiatAccount->currency }}">
