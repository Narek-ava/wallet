        ...
        <div class="col-md-12">
            <form id="regForm" method="post"
                ...
                <div class="tab">
                    ...
                    <a href="{{ route('cabinet.wallets.top_up_crypto', $fiatAccount->id) }}"
                    ...
                    <div class="mt-5 text-left">
                        <input type="text" name="operation_id" hidden value="{{ $wireFiatSelectionDTO->currentOperationId }}">
                        @error('wire_type')
                    ...
                    <div class="row mt-5">
                        <div class="col-md-6 col-lg-3 mb-4">
                            ...
                            <select class="w-100 country" name="country" style="border: 1px solid #bfb7b7;width: 100%!important;"
                                ...
                                @foreach($wireFiatSelectionDTO->countries as $key => $country)
                        ...
                        <input type="hidden" id="exchange_to" name="exchange_to" value="{{ $fiatAccount->currency }}">
                                    ...
                                    <div class="col-md-7">
                                        <div>
                                            <small
                                                ...
                                                id="{{ $wireFiatSelectionDTO->currentOperationId }}">{{ $wireFiatSelectionDTO->currentOperationId }}</small>
            ...
            if (n == 2) {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        "amount" : $('.amount').val(),
                        "fromCurrency" : "{{$fiatAccount->currency}}",
                        "operationType": $("input[type='radio'][name='wire_type']:checked").val(),
                        toCurrency: "{{$fiatAccount->currency}}",
                        wireType: "{{ \App\Enums\OperationType::FIAT_TOP_UP_BY_WIRE }}"
                    },
                    success: function (response) {
        ...
        $(document).ready(function () {
            ...
            setInterval(function(){
                if (getCookie("fileLoading")) {
                    ...
                    location.href = '/cabinet/wallets'; //@todo
                } else {
                    console.log(5);
                }
            },1000);
