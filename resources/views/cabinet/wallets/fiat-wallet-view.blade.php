...
@section('title', strtoupper($fiatWallet->currency) . t('title_wallet_page'))
...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="row mb-5">
                <div class="col-md-12">
                    <h2 class="mb-3 large-heading-section page-title">{{ strtoupper($fiatWallet->currency) }} Wallet</h2>
                    <div class="row">
    ...
    <div class="row">
        <div class="col-md-6" style="max-width: 550px;">
            ...
            <div class="common-shadow-theme wallet-btc btc mt-5 mb-4 ml-0"
                 data-cryptocurrency="{{strtolower($fiatWallet->currency)}}" style="max-width: 100%">
                <div class="label">
                    <img
                ...
                <div class="d-block">
                    ...
                    <a class="btn btn-primary themeBtn btnWhiteSpace mb-2"
                       ...
                       href="{{ route('cabinet.fiat.top_up', $fiatWallet->id) }}" type="submit">Top
                        up</a>
                    <a class="btn btn-primary themeBtn btnWhiteSpace mb-2 {{ $fiatWallet->displayAvailableBalance() <= 0 ? 'disabled' : '' }}"
                       style="border-radius: 30px"
    ...
    <div class="row mt-5 mb-5">
        <div class="col-md-12">
            ...
            <form action="{{ route('cabinet.wallets.fiat.show', $fiatWallet->id) }}" method="get">
                @csrf
                    ...
                    @foreach($operations as $operation)
                        <div class="col-md-12 mt-4 history-element">
                            <div class="row">
                                ...
                                <div class="col-md history-element-item activeLink" data-label-sm="DATE & TIME">{{ $operation->created_at ?? '-'}}</div>
