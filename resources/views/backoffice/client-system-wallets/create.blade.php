    ...
    <div class="row mt-5">
        <div class="col-md-6">
            <form action="#" method="POST" autocomplete="off">
                @csrf
                <h3> {{ t('client_system_wallet_create') }} </h3>
                <div class="form-group mt-5">
                    <div class="form-label-group">
                        <h5><label for="inputWalletId">{{ t('ui_wallet_id') }}</label></h5>
                        <input autocomplete="off" id="inputWalletId" name="walletId" type="text"
                ...
                <div class="form-group mt-5">
                    <div class="form-label-group">
                        ...
                        <input autocomplete="off" type="password" name="passphrase" id="passphraseInput" class="form-control{{ $errors->has('passphrase') ? ' is-invalid' : '' }}" required>
                        @error('passphrase')
