<div class="modal fade modal-center" id="showScriptForm{{$paymentForm->id}}" role="dialog">
        ...
        <div class="modal-content" style="border:none;padding: 25px;width: 900px;border-radius: 30px;">
            <div class="modal-body d-flex align-items-center flex-column">
                <textarea id="paymentFormScript{{ $paymentForm->id }}" rows="5"  disabled="disabled" style="width: 100%; padding: 20px; overflow:hidden; border-radius: 10px; background-color: #f1f1f1">
                    ...
                    <script type="text/javascript" src="{{ $paymentForm->project->domainFullPath() . '/cdn/cratos-form-connector.js'}}" formId="{{ $paymentForm->id }}" domain="{{ $paymentForm->project->domainFullPath() }}"></script>
                </textarea>
