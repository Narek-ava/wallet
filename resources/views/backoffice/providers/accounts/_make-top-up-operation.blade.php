<!-- Modal -->
<div class="modal fade" id="createProviderOperation" tabindex="-1" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
                            ...
                            <div class="col-md-3">
                                <div class = "form-group">
                                    ...
                                    <select id="transaction_type"
                                        ...
                                        <option value="{{ \App\Enums\TransactionType::PROVIDER_TOP_UP_TRX }}">{{ t(\App\Enums\TransactionType::NAMES[\App\Enums\TransactionType::PROVIDER_TOP_UP_TRX ]) }}</option>
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select id="from_type" class = "form-control grey-rounded-border from-type"
                                            name="from_type"
                                            onchange="getFromAccountsByType('from_account_top_up', 1)">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select id="from_account_top_up" class="form-control grey-rounded-border from_account"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select id="to_type"  class="form-control grey-rounded-border"  name="to_type" readonly>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select id="to_account" class="form-control grey-rounded-border"
                                            name="to_account" readonly>
                                        <option value="{{ $account->id }}" hidden>{{ $account->provider->name  }}</option>
                                    </select>
                                    @error('to_account')
                                    <div class="error text-danger">{{ $message }}</div>
                                    @enderror
