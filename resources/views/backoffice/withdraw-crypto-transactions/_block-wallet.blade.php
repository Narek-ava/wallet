            ...
            <div class="modal-body">
                <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control-file" value="" id="exampleFormControlFile1">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <button type="button" class="btn btn-dark themeBtnDark mt-4 w-25">{{ t('block') }}</button>
                    </div>
                </div>
            </div>
        </div>
