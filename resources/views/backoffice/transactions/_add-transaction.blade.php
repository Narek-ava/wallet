            ...
            <div class="modal-body">
                <div>
                    @if($operation->from_account)
                        <form action="{{ in_array($operation->operation_type, [\App\Enums\OperationOperationType::TYPE_CARD_ORDER_PAYMENT_SEPA, \App\Enums\OperationOperationType::TYPE_CARD_ORDER_PAYMENT_SWIFT]) ? route('backoffice.add.transaction.card.order.wire', $operation->id) : route('backoffice.add.transaction', $operation->id) }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3 exchange-api">
                                    <div class="form-group">
                                        <div class="exchange-api">
                                            <div class="form-group">
                                                <input hidden type="text" id="exchange_api" value="{{ $api }}" name="exchange_api">
                                                @error('exchange_api')
                                                <div class="error text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control grey-rounded-border"
                                               value="{{ $allowedMaxAmount ? $allowedMaxAmount : (in_array($operation->from_currency, \App\Enums\Currency::FIAT_CURRENCY_NAMES) ? round($operation->amount, 2) : $operation->amount) }}"
