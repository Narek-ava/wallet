    ...
    <div class="modal-dialog">
        <div class="modal-content" style="border-radius: 31px; padding: 17px">
            ...
            <div class="modal-body">
                <form action="{{ route('backoffice.add.top.up.fiat.wire.bank.detail', $operation->id)}}" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <input type="hidden" name="type" id="type" value="{{ json_decode($operation->additional_data, true)['payment_method'] }}" />
