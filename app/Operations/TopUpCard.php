...
class TopUpCard extends AbstractFiatToCryptoOperation
{
    ...
    public function execute(): void
    {
        try {
            ...
            logger()->error('TopUpCardException', [
    ...
    protected function sendFromLiquidityToWallet()
    {
        ...
        config()->set('projects.project', $this->fromAccount->provider->project);
    ...
    public function refundTransaction()
    {
        ...
        ActivityLogFacade::saveLog(LogMessage::CARD_OPERATION_REFUNDED,
            ...
            $this->_operation->id, $this->_operation->cProfile->cUser->id);
    }
