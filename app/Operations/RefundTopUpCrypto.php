...
class RefundTopUpCrypto extends AbstractOperation
{
    ...
    public function execute(): void
    {
        try {
            ...
            logger()->error('RefundTopUpCryptoException', [
    ...
    protected function sendFromClientToSystem()
    {
        ...
        $this->_collectedCryptoFeeService->saveCollectedCryptoFee($this->clientFeeAmount, $from, $this->_systemAccount, $this->_feeTransactionFromClientToSystem);
    }
    ...
    protected function sendFromClientToExternal()
    {
        ...
        if ($this->_transaction->tx_id) {
            $this->_transaction->status = TransactionStatuses::SUCCESSFUL;
