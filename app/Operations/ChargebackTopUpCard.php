...
class ChargebackTopUpCard extends AbstractOperation
{
    ...
    public function execute(): void
    {
        try {
            ...
            ActivityLogFacade::saveLog(LogMessage::CARD_OPERATION_CHARGEBACK_SUCCESS, ['operationNumber' => $this->_operation->operation_id], LogResult::RESULT_SUCCESS, LogType::TYPE_CARD_OPERATION_CHARGEBACK, $this->_operation->id, $this->_operation->cProfile->cUser->id);
