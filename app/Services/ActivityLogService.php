...
class ActivityLogService implements InterfaceActivityLogService
{
    ...
    {
        if (!in_array($this->type, LogType::MANAGER_LOG_TYPES) && !in_array($this->type, LogType::MANAGER_HISTORY_LOG_TYPES)) {
            return null;
        }
    ...
    public function log(): bool
    {
        ...
        if ($this->createdAt) {
            $context['created_at'] = $this->createdAt;
        }
     ...
     */
    public function saveLog(string $message, array $replacements, int $resultType, int $type, string $contextId = null, $cUserId = null, ?string $createdAt = null)
    {
