...
class CProfileStatuses extends Enum
{
    ...
    const ALLOWED_TO_SEND_COMPLIANCE_REQUEST_STATUSES = [
        self::STATUS_READY_FOR_COMPLIANCE, self::STATUS_ACTIVE
    ]

    ;
    const ALLOWED_TO_ACTIVE_STATUSES = [
        self::STATUS_ACTIVE
    ];

    const ALLOWED_TO_CHANGE_SETTINGS_STATUSES = [
        self::STATUS_NEW, self::STATUS_PENDING_VERIFICATION
    ];

    const ALLOWED_TO_ACCESS_SETTINGS_STATUSES = [
        self::STATUS_NEW, self::STATUS_PENDING_VERIFICATION, self::STATUS_READY_FOR_COMPLIANCE, self::STATUS_ACTIVE, self::STATUS_SUSPENDED
    ];

    const NOT_ALLOWED_TO_ACCESS_SETTINGS_STATUSES = [
        self::STATUS_BANNED
    ];
