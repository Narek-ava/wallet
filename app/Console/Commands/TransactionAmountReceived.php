...
class TransactionAmountReceived extends Command
{
    ...
    public function handle()
    {
        ...
        foreach ($transactions as $transaction) {
            if (in_array($transaction->operation->operation_type,[ OperationOperationType::TYPE_TOP_UP_CRYPTO, OperationOperationType::TYPE_TOP_UP_CRYPTO_PF, OperationOperationType::TYPE_CRYPTO_TO_CRYPTO_PF])) {
